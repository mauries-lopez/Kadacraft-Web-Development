...
export default function Faq({question, desc}: FaqProps){
    ...
    return (
        <>
            <div className="w-full text-center bg-white dark:bg-neutral-800 py-2 px-4 drop-shadow-md rounded-full border-2 border-yellow-400 cursor-pointer" onClick={() => setViewDesc(!viewDesc)}>
